...
def main(test_times):
    ...
    for i in range(input_num):
        ...
        train_in_volume[i][2] = math.pi * radius**2 * height * (-1)**i *1000
    ...
    want_to_know[0][2] = math.pi * 0.5**3 * (-1)**(power+1) *1000


    for i in range(test_times):
        # Calculate trainOutVolume by sygmoid module
        train_out_volume_1 = np.dot(train_in_volume, nn_weight_1)
        train_out_volume_2 = sigmoid(train_out_volume_1, nn_weight_2)
        ...
        # print("intial output = ")
        # print(sigmoid( np.dot(train_in_volume, initial_weight_1), initial_weight_2))
        ...
        print(nn_weight_2)
        # print("final output = ")
        # print(sigmoid( np.dot(train_in_volume, nn_weight_1), nn_weight_2))
        ...
        prediction = float(sigmoid( np.dot(want_to_know, nn_weight_1), nn_weight_2))
